...
export default React.memo(function Table({ header, rows, headerTooltips, sort, sortDir, onSortChange }: TableProps) {
      ...
      <thead>
        <tr>
          {header.map((columnName, i) => (
            <th key={i} data-column-name={columnName} onMouseDown={onClickHeader} title={headerTooltips[i]}>
